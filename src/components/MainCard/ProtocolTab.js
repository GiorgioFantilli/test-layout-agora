      ...
      <div id="department-selection-area">
        <div id="department-suggestions">
          <div className="department-suggestions-header">
            <h3>
              <i className="fa-solid fa-wand-magic-sparkles"></i>Uffici
              Consigliati
            </h3>
          ...
          {aiSuggestionsLoading && (
            ...
            >
              <div className="ai-loading-content">
                ...
                <h4>
                  Analisi AI in corso<span className="loading-dots"></span>
                </h4>
              ...
              <label className="ai-suggestion-label">
                ...
                <div className="suggestion-details">
                  ...
                  <p className="department-description">
                    Competente per autorizzazioni commerciali...
                  </p>{" "}
                </div>{" "}
              </label>
              <label className="ai-suggestion-label">
                ...
                <div className="suggestion-details">
                  ...
                  <p className="department-description">
                    Alternativa per pratiche integrate...
                  </p>{" "}
                </div>{" "}
              </label>
              <label className="ai-suggestion-label">
        ...
        <div className="other-departments-section">
          ...
          <div className="office-listbox">
            <div className="office-list-inner scrollbar-styled">
              <label className="department-list-item">
                {" "}
                <input
                  type="radio"
                  name="department"
              ...
              <label className="department-list-item">
                ...
                <input
                  ...
                  onChange={onOfficeSelect}
                />{" "}
                <span>Ufficio Scuola e Istruzione</span>{" "}
              </label>
              <label className="department-list-item">
                {" "}
                <input
              ...
              <label className="department-list-item">
                ...
                <input
                  ...
                  onChange={onOfficeSelect}
                />{" "}
                <span>Ufficio Cultura e Eventi</span>{" "}
              </label>
              <label className="department-list-item">
                {" "}
                <input
