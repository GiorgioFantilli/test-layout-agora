      ...
      <div className="navbar-content">
        ...
        <div className="search-filter-area">
          <div className="search-wrapper">
            <input
              type="text"
              placeholder="Cerca email, mittenti, oggetti..."
        ...
        <div className="user-controls">
          <div className="user-stack">
            <div className="user-bubble user-bubble-mr">
              <span>MR</span>
            </div>
            <div className="user-bubble user-bubble-ab">
              <span>AB</span>
            </div>
